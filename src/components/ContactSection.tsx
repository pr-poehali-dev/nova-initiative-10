      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-balance">
            Давайте <span className="text-primary">сохраним ваш момент</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Есть фотография, которую хочется сохранить в особенной форме? Напишите нам — поможем выбрать лучший вариант и ответим на все вопросы.
          </p>
        </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      onChange={handleChange}
                      placeholder="Расскажите о вашем заказе: что хотите напечатать, на каком изделии, для какого повода..."
                      rows={6}
                      required
                      className="transition-all focus:scale-[1.02]"
                    />
